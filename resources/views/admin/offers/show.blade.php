            ...
            <div class="room-wrap">
              ...
              <div class="text p-4">
                ...
                <p class="features">
                  ...
                  <span class="d-block mb-2"><i class="icon-check mr-2"></i>Has offer?:{{$trip->has_offer}} </span>
                  <span class="d-block mb-2"><i class="icon-check mr-2"></i>date dl:{{$trip->dead_line}} </span>
                  <span class="d-block mb-2"><i class="icon-check mr-2"></i>Address:{{$trip->address}} </span>
